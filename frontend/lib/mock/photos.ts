...
function photo(n: number, o: Partial<Photo>): Photo {
  ...
  const year = result.date_taken ? Number(result.date_taken.slice(0, 4)) : null;
  result.freshness = year === null ? "date_unknown" : year >= 2024 ? "2024_plus" : year >= 2020 ? "2020_2023" : year < 1950 ? "historic" : "older";
  return result;
}
...
export const PHOTOS: Photo[] = [
  ...
  photo(2, {
    ...
    source_domain: "openstreetmap.org", license: "ODbL", author: "OSM contributor", date_taken: "2025-03-02",
  ...
  photo(3, {
    ...
    placeholder_caption: "sports field · placeholder", author: "S. Lim", date_taken: "2023-10-18",
  ...
  photo(4, {
    ...
    license: "© Официальный сайт, разрешено к показу", author: "Korea University", date_taken: "2025-01-24",
  ...
  photo(5, {
    ...
    placeholder_caption: "reading room · placeholder", author: "H. Choi", date_taken: "2024-11-06",
  ...
  photo(6, {
    ...
    source_domain: "mapillary.com", author: "Mapillary user", date_taken: "2025-06-14",
  ...
  photo(7, {
    ...
    placeholder_caption: "campus path · placeholder", author: "Anonymous", date_taken: "2022-09-30",
  ...
  photo(8, {
    ...
    license: "CC BY 2.0", author: "flickr user", date_taken: "2023-04-11",
  ...
  photo(9, {
    ...
    placeholder_caption: "student cafe · placeholder", author: "Y. Kim", date_taken: "2024-02-20",
  ...
  photo(10, {
    ...
    license: "CC BY 2.0", author: "flickr user", date_taken: "2021-11-02",
  ...
  photo(11, {
    ...
    source_domain: "example-blog.kr", license: "unknown", author: "—", date_taken: "2020-07-15",
  ...
  photo(12, {
    ...
    source_domain: "web-search-result.example", license: "unknown", author: "—", date_taken: "2019-05-08",
  ...
  photo(13, {
    ...
    placeholder_caption: "archive shelves · placeholder", author: "D. Seo", date_taken: "2025-08-01",
  ...
  photo(14, {
    ...
    placeholder_caption: "seminar room · placeholder", author: "M. Han", date_taken: "2024-09-19",
